...
namespace MotorFest.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage ="Полето за текуща парола е задължително")]
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Паролата трябва да бъде минимум 6 символа", MinimumLength = 6)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!changePasswordResult.Succeeded)
            {
                foreach (var error in changePasswordResult.Errors)
                {
                    ...
                    {
                        error.Description = "Грешна парола";
                    }
            ...
            StatusMessage = "Успешно променихте паролата си";
