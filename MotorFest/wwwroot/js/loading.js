...
TweenMax.to(mainContainer, 20, {
    ...
    ease: Linear.easeNone,
    onComplete: function () {
        console.log("Loading screen анимацията приключи!"); // Дебъг
        if (typeof startFlyInAnimations === "function") {
            console.log("Извикване на startFlyInAnimations..."); // Дебъг
            startFlyInAnimations();
        } else {
            console.error("startFlyInAnimations не е дефинирана!"); // Дебъг
        }
    }
});
